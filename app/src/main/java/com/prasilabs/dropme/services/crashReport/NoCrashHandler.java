package com.prasilabs.dropme.services.crashReport;
...
import com.prasilabs.dropme.activities.SorryCrashActivity;
...
public class NoCrashHandler {
    ...
    public static void sendExceptionReport(String s, CrashType crashType) {
        CrashReportModelEngine.getInstance().reportCrash(s, crashType);
    }
}