...
public class DropMeApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetRideDetailList getRideDetailList(java.util.List<java.lang.Long> ids) throws java.io.IOException {
    GetRideDetailList result = new GetRideDetailList(ids);
    initialize(result);
    return result;
  }
  ...
  public class GetRideDetailList extends DropMeApiRequest<com.prasilabs.dropme.backend.dropMeApi.model.RideDetailCollection> {
     ...
     * @since 1.13
     */
    protected GetRideDetailList(java.util.List<java.lang.Long> ids) {
