...
public class DropMeApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * @param hash
   * @param content the {@link com.prasilabs.dropme.backend.dropMeApi.model.VRide}
   * @return the request
   */
  public CreateRide createRide(java.lang.String hash, com.prasilabs.dropme.backend.dropMeApi.model.VRide content) throws java.io.IOException {
    CreateRide result = new CreateRide(hash, content);
    initialize(result);
    return result;
  }

  public class CreateRide extends DropMeApiRequest<com.prasilabs.dropme.backend.dropMeApi.model.ApiResponse> {
     ...
     * @since 1.13
     */
    protected CreateRide(java.lang.String hash, com.prasilabs.dropme.backend.dropMeApi.model.VRide content) {
      super(DropMeApi.this, "POST", REST_PATH, content, com.prasilabs.dropme.backend.dropMeApi.model.ApiResponse.class);
      this.hash = com.google.api.client.util.Preconditions.checkNotNull(hash, "Required parameter hash must be specified.");
    }
