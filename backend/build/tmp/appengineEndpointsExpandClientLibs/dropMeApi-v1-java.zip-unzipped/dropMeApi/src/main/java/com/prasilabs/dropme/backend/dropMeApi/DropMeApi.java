...
public class DropMeApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public CancelRide cancelRide(java.lang.String hash, java.lang.Long rideId) throws java.io.IOException {
    CancelRide result = new CancelRide(hash, rideId);
    initialize(result);
    return result;
  }
  ...
  public class CancelRide extends DropMeApiRequest<com.prasilabs.dropme.backend.dropMeApi.model.ApiResponse> {
    ...
    private static final String REST_PATH = "cancelRide/{hash}/{rideId}";
     ...
     * @since 1.13
     */
    protected CancelRide(java.lang.String hash, java.lang.Long rideId) {
    ...
    public CancelRide setHash(java.lang.String hash) {
      this.hash = hash;
      return this;
    }
    ...
    public CancelRide setRideId(java.lang.Long rideId) {
      this.rideId = rideId;
      return this;
    }
   ...
   * @return the request
   */
  public CreateRide createRide(java.lang.String hash, com.prasilabs.dropme.backend.dropMeApi.model.RideInput content) throws java.io.IOException {
    CreateRide result = new CreateRide(hash, content);
    initialize(result);
    return result;
  }
  ...
  public class CreateRide extends DropMeApiRequest<com.prasilabs.dropme.backend.dropMeApi.model.RideInput> {
    ...
    private static final String REST_PATH = "createRide/{hash}";
     ...
     * @since 1.13
     */
    protected CreateRide(java.lang.String hash, com.prasilabs.dropme.backend.dropMeApi.model.RideInput content) {
    ...
    public CreateRide setHash(java.lang.String hash) {
      this.hash = hash;
      return this;
    }
   ...
   * @return the request
   */
  public GetCurrentRide getCurrentRide(java.lang.String hash, java.lang.String deviceId) throws java.io.IOException {
    GetCurrentRide result = new GetCurrentRide(hash, deviceId);
    initialize(result);
    return result;
  }
  ...
  public class GetCurrentRide extends DropMeApiRequest<com.prasilabs.dropme.backend.dropMeApi.model.RideInput> {
    ...
    private static final String REST_PATH = "rideinput/{hash}/{deviceId}";
     ...
     * @since 1.13
     */
    protected GetCurrentRide(java.lang.String hash, java.lang.String deviceId) {
    ...
    public GetCurrentRide setHash(java.lang.String hash) {
      this.hash = hash;
      return this;
    }
   ...
   * @return the request
   */
  public GetRideDetailList getRideDetailList(java.lang.String hash, java.util.List<java.lang.Long> ids) throws java.io.IOException {
    GetRideDetailList result = new GetRideDetailList(hash, ids);
    initialize(result);
    return result;
  }
  ...
  public class GetRideDetailList extends DropMeApiRequest<com.prasilabs.dropme.backend.dropMeApi.model.RideDetailCollection> {
    ...
    private static final String REST_PATH = "ridedetailcollection/{hash}/{ids}";
     ...
     * @since 1.13
     */
    protected GetRideDetailList(java.lang.String hash, java.util.List<java.lang.Long> ids) {
      super(DropMeApi.this, "GET", REST_PATH, null, com.prasilabs.dropme.backend.dropMeApi.model.RideDetailCollection.class);
      this.hash = com.google.api.client.util.Preconditions.checkNotNull(hash, "Required parameter hash must be specified.");
    ...
    public GetRideDetailList setHash(java.lang.String hash) {
      this.hash = hash;
      return this;
    }
