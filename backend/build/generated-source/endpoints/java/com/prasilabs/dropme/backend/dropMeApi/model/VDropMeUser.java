...
public final class VDropMeUser extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private com.google.api.client.util.DateTime dob;
   ...
   * @return value or {@code null} for none
   */
  public com.google.api.client.util.DateTime getDob() {
    return dob;
  }
   ...
   */
  public VDropMeUser setDob(com.google.api.client.util.DateTime dob) {
    this.dob = dob;
    return this;
  }
   ...
   */
  public VDropMeUser setMessage(java.lang.String message) {
