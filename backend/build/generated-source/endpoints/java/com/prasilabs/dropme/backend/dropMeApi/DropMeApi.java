...
public class DropMeApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public CancelRide cancelRide(java.lang.String hash, java.lang.String deviceId) throws java.io.IOException {
    CancelRide result = new CancelRide(hash, deviceId);
    initialize(result);
    return result;
  }
  ...
  public class CancelRide extends DropMeApiRequest<com.prasilabs.dropme.backend.dropMeApi.model.ApiResponse> {
    ...
    private static final String REST_PATH = "cancelRide/{hash}/{deviceId}";
     ...
     * @since 1.13
     */
    protected CancelRide(java.lang.String hash, java.lang.String deviceId) {
